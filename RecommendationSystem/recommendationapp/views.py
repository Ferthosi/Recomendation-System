...
def information(request):
    return render(request, "recommendationapp/information.html")

def ticketprice(request):
    return render(request,"recommendationapp/ticketprice.html")

def Routemap(request):
    return render(request,"recommendationapp/Routemap.html")

def wikipedia(request):
    return render(request, "recommendationapp/wikipedia.html")
